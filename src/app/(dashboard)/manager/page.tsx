...
export default function ManagerHubPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto safe-area-top">
      {/* Header Banner */}
      <div className="glass-panel p-4 md:p-5 rounded-2xl border border-slate-200 bg-gradient-to-r from-purple-50/70 via-indigo-50/50 to-white flex items-center justify-between gap-4 shadow-sm">
