...
import { Users, UserPlus, ShieldCheck, Key, Edit3, Lock, Unlock, Phone, DollarSign, Wallet, Clock, Search, CheckCircle2, AlertCircle, Shield, Check } from 'lucide-react';
          ...
          <table className="w-full text-right text-sm text-slate-700">
            ...
            <tbody className="divide-y divide-slate-200">
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="text-center py-12 text-slate-500">لا يوجد موظفين تطابق البحث</td>
                </tr>
              ) : (
                filteredUsers.map((u) => (
