  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      >
        ...
        <RuleRow
          status="blocked"
          label="ممنوع — وجود فواتير قيد التنفيذ"
          desc="يمنع إنهاء الشفت في حالة وجود أي فواتير مفتوحة بحالة (قيد التنفيذ) لم تتكتمل بعد."
        />
        <RuleRow
          status="allowed"
          label="مسموح — الكاش صفر، العهد مصفّرة، ولا توجد فواتير مفتوحة"
          desc="يسمح بإنهاء الشفت عند وصول رصيد عهدة الكاش إلى صفر وعدم وجود أي عهدة مستلمة أو فواتير قيد التنفيذ."
        />
      </RuleCard>
      ...
      {/* ─── ٥. قيود التعديل والحذف وأثرها على عهدة الكاش ─── */}
      <RuleCard
        icon={<Trash2 className="w-5 h-5" />}
        title="٥. قيود وقواعد التعديل والحذف وأثرها على عهدة الكاش"
      ...
      >
        <RuleRow
          status="allowed"
          label="الموظف — الفواتير المفتوحة (قيد التنفيذ) فقط"
          desc="يُسمح للموظف بتعديل أو حذف أي بند من بنود المبيعات طالما الفاتورة بحالة (قيد التنفيذ). وبمجرد إنهاء الفاتورة وتحولها إلى (مكتملة)، يُقفل القيد ويُمنع الموظف نهائياً من أي تعديل أو حذف."
        />
        <RuleRow
          status="info"
          label="المدير — صلاحية التعديل والحذف الدائمة"
          desc="يحق للمدير تعديل أو حذف أي بند أو عملية بيع في أي وقت وبدون قيود زمنية، سواء كانت الفاتورة بحالة (قيد التنفيذ) أو (مكتملة)."
        />
        <RuleRow
          status="warning"
          label="تأثير التعديل والحذف إذا كان الشفت مفتوحاً 🟢"
          desc="إذا كان شفت الموظف لا يزال مفتوحاً (نشط): يتم تعديل وعكس التأثير المالي فورياً على (عهدة الكاش الشخصية للموظف) وأيضاً على (أرصدة المحافظ والماكينات الخارجية) لتعكس القيم الصحيحة المعدلة أو المحذوفة."
        />
        <RuleRow
          status="info"
          label="تأثير التعديل والحذف إذا كان الشفت مغلقاً 🔴"
          desc="إذا كان شفت الموظف مغلقاً (منتهي): لا تتأثر عهدة الكاش ولا تتأثر أرصدة المحافظ والماكينات الخارجية نهائياً (تظل الأرصدة الحالية كما هي دون تغيير)، ويتم التعديل أو الحذف بالداتا بيز والسجلات فقط للحفاظ على الميزانيات المعتمدة للشفتات المغلقة."
        />
      </RuleCard>
      ...
      <RuleCard
        ...
        title="٦. التطبيق الموحد على الجميع"
