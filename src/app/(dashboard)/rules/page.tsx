...
export default function RulesPage() {
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {/* ─── ٩. زر تسليم جميع العهد لماسبيرو ─── */}
      <RuleCard
        icon={<span className="text-lg">🏛️</span>}
        title="٩. زر تسليم جميع العهد لـ ماسبيرو (المركز)"
        color="text-emerald-700"
        borderColor="border-emerald-200"
        bgColor="bg-emerald-50"
      >
        <p className="text-xs text-slate-500 pb-1">
          هذا الزر الظاهر في أعلى صفحة إدارة الشفتات مخصص لإغلاق اليوم بضغطة واحدة.
        </p>

        <RuleRow
          status="info"
          label="ماذا يفعل؟"
          desc="يُسلّم في خطوة واحدة كل العهد المسجلة في عهدة الموظف الحالي (محافظ + ماكينات + أدراج) إلى ماسبيرو المركز مباشرة."
        />
        <RuleRow
          status="info"
          label="ما الذي يتغير في النظام؟"
          desc="كل عهدة في عهدته تُفرَّغ من اسمه وتُسجَّل باسم ماسبيرو (المركز) — ويُحفظ سجل تسليم تلقائي لكل عهدة على حدة في تاريخ التسليم."
        />
        <RuleRow
          status="warning"
          label="لا يُعيد الأرصدة النقدية"
          desc="الزر يُحرر العهدة من عهدة الموظف لكنه لا يخصم أو يُعيد أي مبالغ نقدية من رصيده الشخصي — العهدة النقدية (الكاش) تُعالج بشكل منفصل عبر تسليم الكاش بالدرج."
        />
        <RuleRow
          status="warning"
          label="لا يوجد تحقق من الأرصدة"
          desc="النظام يُسلّم العهد بأرصادها الحالية في النظام دون طلب تأكيد الرصيد الفعلي — الفارق بين المتوقع والفعلي يُسجَّل صفراً تلقائياً."
        />
        <RuleRow
          status="info"
          label="ماذا لو لم تكن لديه أي عهد؟"
          desc="إذا لم يكن الموظف يحمل أي عهدة، يظهر له إشعار بأنه لا توجد عهد مسجلة — ولا يحدث أي تغيير."
        />
        <RuleRow
          status="allowed"
          label="متاح لكل الموظفين والمدير"
          desc="لا يشترط النظام حالة شفت معينة لاستخدام هذا الزر — أي موظف أو المدير يستطيع الضغط عليه في أي وقت."
        />
        <RuleRow
          status="info"
          label="يفتح ماذا للشفت التالي؟"
          desc="بعد التسليم، العهد تصبح منسوبة لماسبيرو وليست لأحد — مما يعني أن موظف الشفت الصباحي التالي سيجد كل المحافظ والماكينات غير مستلمة وجاهزة للاستلام من جديد."
        />
        <RuleRow
          status="blocked"
          label="لا يُغلق الشفت تلقائياً"
          desc="الضغط على هذا الزر لا يُنهي الشفت — على الموظف إنهاء شفته بشكل منفصل بعد الانتهاء من التسليم."
        />
      </RuleCard>
