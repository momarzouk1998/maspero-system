    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      >
        ...
        <RuleRow
          ...
          desc="إذا كان شفت الموظف المنفذ للعملية لا يزال مفتوحاً (نشط): يتم عكس خصم/إضافة المبالغ على رصيد عهدة الكاش للموظف وأرصدة المحافظ تلقائياً وفورياً لتعكس القيم الصحيحة."
        />
        <RuleRow
          status="info"
          label="تأثير التعديل والحذف إذا كان الشفت مغلقاً 🔴"
          desc="إذا كان شفت الموظف المنفذ للعملية مغلقاً (منتهي): يتم تعديل أو حذف البيانات من السجلات والداتا بيز فقط دون المساس برصيد الكاش الحالي للموظف لحفظ الميزانيات المعتمدة للشفتات المغلقة."
        />
      </RuleCard>
