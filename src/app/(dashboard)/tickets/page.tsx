    ...
    <div className="space-y-6 safe-area-top">
      ...
      <div className="glass-panel px-4 py-3.5 rounded-2xl border border-slate-200 space-y-2.5">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-base md:text-xl font-bold text-slate-900 flex items-center gap-2">
            <Train className="w-5 h-5 md:w-6 md:h-6 text-purple-600 shrink-0" />
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 min-w-0">
            ...
            <input
              ...
              className="w-full pl-4 pr-10 py-2.5 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
            />
          </div>
          <button
      ...
      <div className="flex-1 space-y-4 min-w-0">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-right text-sm text-slate-700 min-w-[700px]">
