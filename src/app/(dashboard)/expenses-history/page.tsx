          ...
          <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200 overflow-x-auto no-scrollbar">
            {[
              ...
              <button
                ...
                className={`py-1.5 px-3 rounded-lg text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${mainTypeFilter === cat.id
            ...
            <div className="flex items-center gap-1 bg-amber-50 p-1 rounded-xl border border-amber-200 overflow-x-auto no-scrollbar">
              ...
              {availableMonths.map(m => (
                <button
                  ...
                  className={`py-1 px-2.5 rounded-lg text-xs font-mono font-bold transition-all cursor-pointer whitespace-nowrap ${selectedMonth === m
            ...
            <div className="flex items-center gap-1 bg-cyan-50 p-1 rounded-xl border border-cyan-200 overflow-x-auto no-scrollbar">
              ...
              {availableDays.map(dStr => (
                <button
                  ...
                  className={`py-1 px-2 rounded-lg text-xs font-mono font-bold transition-all cursor-pointer whitespace-nowrap ${selectedDay === dStr
